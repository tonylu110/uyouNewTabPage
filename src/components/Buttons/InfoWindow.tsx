...
const InfoWindow: FC<IInfoWindowProps> = ({
  ...
  return (
    <div className={`${infoWindowShow ? `scale-100 md:right-[calc(50%-400px)] md:bottom-[calc(50%-300px)] ${new mobileCheck().isMobile() ? 'top-[calc(50%-240px)]' : ''}` : `scale-0 md:-right-[360px] md:-bottom-[260px] ${new mobileCheck().isMobile() ? '-top-[400px]' : ''}`} fixed z-[200] w-[350px] h-[480px] md:w-[800px] md:h-[600px] bg-white/60 shadow-2xl backdrop-blur rounded-[20px] p-[25px] md:p-[50px] flex flex-col border-t-[2px] border-r-[2px] border-solid border-white/50 transition-all duration-500 text-black`}>
      <div
        className='close-btn'
      ...
      <div className='overflow-y-scroll rounded-[15px]'>
        ...
        <div className='flex flex-col'>
          <div className="bg-white/60 p-[15px] text-[15px] rounded-[15px] mb-[15px] font-bold">
