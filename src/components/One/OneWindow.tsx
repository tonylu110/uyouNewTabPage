...
const OneWindow: FC<IOneWindowProps> = ({
  ...
  return (
    <div className={`w-[310px] h-[440px] p-[40px] bottom-[-50vh] ${oneWindowShow ? 'bottom-[calc(50%-152px)]' : 'md:bottom-[-170px]'} ${oneWindowShow ? 'scale-100' : 'scale-0'} fixed z-[21] md:w-[600px] md:h-[350px] bg-white-90 shadow-2xl backdrop-blur rounded-[20px] flex flex-row border-t-[2px] border-solid border-white-70 transform duration-500`}>
